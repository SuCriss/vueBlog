<template>
  <div class="ibody">
    <header>
      ...
      <nav id="topnav"><router-link to="/page/home">首页</router-link><router-link to="/page/about" id="current">关于我</router-link><router-link to="/page/newList">慢生活</router-link><router-link to="/page/share">模板分享</router-link><router-link to="/page/theme">模板主题</router-link></nav>
    </header>
    <article>
      ...
      <div class="about">
        <h2>Just about me</h2>
        <ul>
          <p>方晴，女，一个80后草根女站长！09年入行，从业已经有三四年。从搬砖一样的生活方式换成了现在有“单”而居的日子。当然这个单不是单身的单，跟我的职业相比，爱情脱单并不是问题！虽然极尽苛刻的征婚条件但也远不及客户千奇百怪的要求。告别了朝九晚五，躲过了风吹日晒，虽然不再有阶梯式的工资，但是偶尔可以给自己放放假，挽着老公，一起轻装旅行。</p>
    ...
    <aside>
      <div class="avatar"><a href="about.html"><span>关于方晴</span></a></div>
      ...
      <div class="about_c">
        ...
        <p>籍贯：福建省―厦门市</p>
        <p>电话：13662012345</p>
        <p>邮箱：fangqing@163.com</p>
        <p><a target="_blank" href="http://mail.qq.com/cgi-bin/qm_share?t=qm_mailme&amp;email=HHh9cn95b3F1cHVye1xtbTJ-c3E" ><img src="http://rescdn.qqmail.com/zh_CN/htmledition/images/function/qm_open/ico_mailme_22.png" alt="方晴个人博客网站"></a></p>
        <p>
...
<script>
  ...
  import '../assets/lib/home/css/about.css'
